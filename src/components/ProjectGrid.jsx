...
return (
    <a 
        href={project.link}
        className="block aspect-square bg-paper border-2 border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow"
    >
    ...
    <div className="p-4 h-1/2 flex flex-col">
        <div className="flex items-center justify-between mb-2">
            <h3 className="text-lg font-medium text-rose-800 truncate">
            {project.name}
        </h3>
...
const ProjectsGrid = () => {
    ...
    return (
    <div className="max-w-6xl mx-auto p-6 sm:p-2">
